...
public class AddStudent {
	...
	private JTextField firstName; // first name of student to enter
	private JTextField lastName; // last name of student to enter
	private JTextField roomNumber; // room number of student to enter
	private JTextField noDaysBooked; // number of days the student wants to book
	...
	private JScrollPane scrollBar2;// scroll bar for Jtext Area potentialPrice
	// i need the scroll bar for Jtext Area in order to display, without it. The
	...
	private JLabel NoOfStudentsLabel; // No of Students label
	private JLabel NoOfVisitorsLabel; // No of visitors label
	...
	private JComboBox students; // drop down box for No of students
	private JComboBox visitor;// drop down box for No of visitor
	...
	private static final String[] titles = { "Mr", "Ms", "Miss", "Mrs", "Dr",
			"Prof" };
	private static final String[] noStudents = { "1", "2", "3", "4" };
	private static final String[] noVisitors = { "0", "1", "2", "3", "4" };
	// columns name for the Jtable
	String column_names[] = { "Course/Room Number", "Day/Time", "Tutor Name" };
	...
	// getter method for No of visitor drop down box
	public JComboBox getNoVisitors() {
		return this.visitors;
	}

	// getter method for students No of students
	public JComboBox getNoStudents() {
	...
	public JPanel Container(Object o) throws FileNotFoundException {
		...
		NoOfStudentsLabel = new JLabel("No. of Students: ");
		NoOfStudentsLabel.setBounds(48, 165, 220, 30);
		page.add(NoOfStudentsLabel);
		// no of visitors label
		NoOfVisitorsLabel = new JLabel("Visitors:");
		NoOfVisitorsLabel.setBounds(225, 165, 220, 30);
		page.add(NoOfVisitorsLabel);
		// instantiating the J drop down box for No of Students
		students = new JComboBox(noStudents);
		students.setBounds(146, 165, 70, 30);
		students.addActionListener((ActionListener) o);
		page.add(students);
		// instantiating the J drop down box for No of Visitor
		visitors = new JComboBox(noVisitors);
		visitors.setBounds(290, 165, 70, 30);
		visitors.addActionListener((ActionListener) o);
		page.add(visitors);
		// room number label
				...
				if (roomBooking.verify(Integer.parseInt(roomNumber.getText()))) {
					...
					if (firstName.getText().length() > 0
						...
						tenant.addTenant(titles[title.getSelectedIndex()],
								...
								noStudents[students.getSelectedIndex()],
								noVisitors[visitors.getSelectedIndex()],
								Integer.parseInt(noDaysBooked.getText()),
